...
#define X_STEPS_PER_MM   9.849979631178913//7.99735
#define X_STEPS_PER_INCH (X_STEPS_PER_MM*INCHES_TO_MM) // *RO
#define INVERT_X_DIR 0

#define Y_STEPS_PER_MM   9.815579846229039//7.99735
#define Y_STEPS_PER_INCH (Y_STEPS_PER_MM*INCHES_TO_MM) // *RO
#define INVERT_Y_DIR 0

#define Z_STEPS_PER_MM   323.2062055591467//320
#define Z_STEPS_PER_INCH (Z_STEPS_PER_MM*INCHES_TO_MM) // *RO
#define INVERT_Z_DIR 1
...
// 0.706
#define E_STEPS_PER_MM   9.5   // NEMA17 extruder 5mm diameter drive - empirically adjusted
#define W_STEPS_PER_MM   2.5
...
#define SLOW_XY_FEEDRATE 200.0 // Speed from which to start accelerating
#define SLOW_Z_FEEDRATE 5
